...
apiDatatable("{{url('/view_admins?api_token='.Auth::user()->api_token)}}",1,col);

function del(id){
    var myhtml = document.createElement("div");
    var del = '<form action="/delete_user/'+id+'" method="POST">@csrf<button type="submit" class="btn btn-danger"><i class="material-icons">&#xE872;</i> Delete Admin</button>';
